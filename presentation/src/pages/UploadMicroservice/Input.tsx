        ...
        <div className="flex items-center mx-4" key={props.index}>
              ...
              <div className="w-1/2">
                ...
                <input
                  ...
                  className="rounded-lg p-2 border w-2/3 border-gray-300 hover:shadow-md"
                />
                <button type="button" onClick={() => props.handleRemoveInput(props.index)} className="bg-gray-300 rounded-lg py-1 px-2 hover:shadow-md">
                  <img src={MinusSvg} alt="remove" className="w-8 h-8"/>
                </button>
                {props.index === props.inputsLength - 1 && (
                  <button type="button" onClick={() => props.handleAddInput} className="bg-gray-300 rounded-lg py-1 px-2 hover:shadow-md">
