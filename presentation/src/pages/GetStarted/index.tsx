    ...
    <div className="container mx-auto p-4 lg:w-2/5">
      <div className="p-2 bg-gray-200 my-12 mx-auto rounded-xl drop-shadow-lg">
        ...
        <div className="flex items-center justify-center mb-4">
          <button className="bg-gray-300 rounded-lg m-4 py-2 px-2 hover:shadow-md" onClick={handleDeveloperSelect}>
            Developer
          </button>
          <button className="bg-gray-300 rounded-lg m-4 py-2 px-2 hover:shadow-md" onClick={handleConsumerSelect}>
            Consumer
          </button>
        </div>
      </div>
