...
const ConsumerLogin = () => {
  ...
  return (
    <div className="container mx-auto p-4 lg:w-2/5" style={{ backgroundImage: `url(${orcaArt})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <div className="p-2 bg-gray-200 my-12 mx-auto rounded-xl drop-shadow-lg">
        <form onSubmit={data.handleSubmit}>
          ...
          <div className="flex flex-col items-center mx-auto">
            <button className="bg-gray-300 rounded-lg m-4 py-2 px-2 hover:shadow-md">Login</button>
