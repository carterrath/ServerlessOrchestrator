        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Serverless Orchestrator</h1>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                A microservice platform enhancing software efficiency through scalable, independent service
                deployability for streamlined development.
              </p>
