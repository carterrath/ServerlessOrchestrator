    ...
    return(
        <div className="top-0 z-[999999999999] sticky w-full h-20 px-4 items-center flex drop-shadow-xl bg-gradient-to-r from-darkPink to-amaranthPink justify-between">
            <div className="flex gap-6 items-center">
                ...
                <Link className="hover:scale-105 transition duration-150 ease-in-out text-white" to="/Home">
                    Home
                </Link>
                <Link className="hover:scale-105 transition duration-150 ease-in-out text-white" to="/Microservices">
                    Microservices
                </Link>
                {props.isDeveloper && (
                    <Link className="hover:scale-105 transition duration-150 ease-in-out text-white" to="/UploadMicroservice">
                        Upload
                    </Link>
                )}     
            </div>
